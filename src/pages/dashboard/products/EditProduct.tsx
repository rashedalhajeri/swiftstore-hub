...
const sampleProducts = [
  {
    ...
    price: 299.99,
    comparePrice: 349.99,
    description: "هاتف ذكي متطور مع كاميرا عالية الدقة وشاشة AMOLED ممتازة",
    ...
    attributes: [
      { key: "الشاشة", value: "6.1 بوصة" },
      { key: "الكاميرا", value: "50 ميجابكسل" },
      { key: "البطارية", value: "4500 مللي أمبير" }
    ],
    variants: ["أسود", "أبيض", "أزرق"],
    weight: 0.2,
    width: 7.5,
    height: 15.5,
    length: 0.8
  },
  {
    ...
    sku: "AUDIO-001",
    price: 149.99,
    description: "سماعات لاسلكية ممتازة مع ميزة إلغاء الضوضاء",
    category: "electronics",
    stock: 12,
    sold: 8,
    featured: false,
    ...
    attributes: [
      { key: "إلغاء الضوضاء", value: "نعم" },
      { key: "عمر البطارية", value: "30 ساعة" }
    ],
    variants: ["أسود", "فضي"],
    weight: 0.3,
    width: 18,
      ...
      try {
        ...
        if (foundProduct) {
          ...
          form.reset({
            ...
            status: foundProduct.status as 'active' | 'draft' | 'out_of_stock',
          ...
          if (foundProduct.images && foundProduct.images.length > 0) {
            setImages(foundProduct.images.map(img => ({ preview: img })));
          }
          
          // Set attributes
          if (foundProduct.attributes && foundProduct.attributes.length > 0) {
            setAttributes(foundProduct.attributes);
          }
          
          // Set variants
          if (foundProduct.variants && foundProduct.variants.length > 0) {
            setVariantOptions(foundProduct.variants);
          }
        } else {
    ...
    return (
      <div className="space-y-6" style={{ direction: "rtl" }}>
        <Alert variant="destructive">
          <AlertTitle>المنتج غير موجود</AlertTitle>
          <AlertDescription>
            لم يتم العثور على المنتج المطلوب. يرجى التحقق من الرابط والمحاولة مرة أخرى.
          </AlertDescription>
        </Alert>
    ...
    <div className="space-y-6" style={{ direction: "rtl" }}>
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          <h2 className="text-2xl font-bold tracking-tight">تعديل المنتج</h2>
                                ...
                                {variantOptions.map((option, index) => (
                                  <div key={index} className="p-3 border rounded-md">
                                    ...
                                    <div className="mt-2 flex justify-between text-muted-foreground">
                                      <span>المخزون: 10</span>
                                      <span>السعر: 299.99 KWD</span>
                                    </div>
                                  </div>
                                ))}
                              </div>
